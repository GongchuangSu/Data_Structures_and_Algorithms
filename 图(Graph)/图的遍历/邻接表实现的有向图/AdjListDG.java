/**
 * @description 邻接表表示的有向图(Matrix Directed Graph)的
...
public class AdjListDG {
    ...
    public AdjListDG(char[] vexs, char[][] edges) {
        // 初始化顶点个数和边个数
        vlen = vexs.length;
        elen = edges.length;
    ...
    public static void main(String[] args) {
        ...
        AdjListDG adjListDG = new AdjListDG(vexs, edges);
        adjListDG.print();
        adjListDG.DFSTraverse(vertexNodeList);
        adjListDG.BFSTraverse(vertexNodeList);
    }
}
